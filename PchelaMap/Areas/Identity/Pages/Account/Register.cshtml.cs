...
namespace PchelaMap.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name= "Согласие на обработку и хранение персональных данных:")]
            //[Range(typeof(bool), "true", "true", ErrorMessage = "для продолжения необходимо подтверждение")]
            public bool UserPrivacyConfirm { get; set; }
