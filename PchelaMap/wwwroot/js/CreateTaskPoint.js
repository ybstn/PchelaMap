...
function init() {
    ...
    $("#UrgentCheckButton").click(function () {
        //var TaskscircleLayout = "";
        //var ClassName = $(this).attr('class');
        //if (ClassName.includes("off")) {
        //    TaskscircleLayout = ymaps.templateLayoutFactory.createClass("<div class='urgent_task_placemark_layout_container'><div class='urgent_task_circle_layout'/></div>");
        //}
        //else
        //{
        //    TaskscircleLayout = ymaps.templateLayoutFactory.createClass("<div class='task_placemark_layout_container'><div class='task_circle_layout'/></div>");
        //}
        //myMap.geoObjects.each(function (geoObject) {
        //    geoObject.options.set('iconContentLayout', TaskscircleLayout);
        //});
    });
